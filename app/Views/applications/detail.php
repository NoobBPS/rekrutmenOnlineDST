...
<div class="application-detail">
    ...
    <div class="detail-grid">
        ...
        <div class="detail-card">
            ...
            <a href="<?= BASE_URL ?>chat/userStart/<?= (int) ($application['id'] ?? 0) ?>" class="btn btn-sm btn-primary mt-8">
                <svg viewBox="0 0 24 24" fill="none" width="15" height="15" style="vertical-align:middle;margin-right:4px" aria-hidden="true">
                    <path d="M12 4C7.03 4 3 7.47 3 11.75c0 2.12.99 4.03 2.6 5.37l-.47 3.13 3.02-1.4C9.34 19.25 10.64 19.5 12 19.5c4.97 0 9-3.47 9-7.75C21 7.47 16.97 4 12 4Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/>
                </svg>
                Chat dengan HRD
            </a>
            <?php endif; ?>

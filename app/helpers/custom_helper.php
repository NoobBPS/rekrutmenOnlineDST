...
if (!defined('UPLOAD_ROOT')) {
    define('UPLOAD_ROOT', FCPATH . 'uploads/');
}
...
// redirect() removed. Controllers must use return redirect()->to(...)
...
function db() {
    static $model = null;
    if ($model === null) {
        require_once APPPATH . 'Models/CustomDBWrapper.php';
        $model = new \App\Models\CustomDBWrapper();
    }
    return $model;
}

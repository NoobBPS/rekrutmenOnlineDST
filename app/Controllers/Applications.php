...
class Applications extends Controller {
    ...
    public function detail($id) {
        ...
        $this->view('layouts/header', $data);
        $this->view('applications/detail', $data);
        $this->view('layouts/footer');
    }
    ...
    public function hrd() {
        ...
        $this->view('layouts/header', $data);
        $this->view('applications/hrd', $data);
        $this->view('layouts/footer');
    }
    ...
    public function applyRecommendation() {
        ...
        $application = db()->row("SELECT id, notes FROM applications WHERE id = ?", [$application_id]);
    ...
    public function addNote() {
        ...
        if (empty($note)) {
            $this->json(['success' => false, 'message' => 'Catatan tidak boleh kosong']);
        }
        
        $application = db()->row("SELECT notes FROM applications WHERE id = ?", [$application_id]);
        
        if (!$application) {
            $this->json(['success' => false, 'message' => 'Lamaran tidak ditemukan']);
        }
        ...
        $this->json(['success' => true, 'message' => 'Catatan ditambahkan']);
    }
